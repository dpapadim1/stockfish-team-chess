...
constexpr int BUTTERFLY_HISTORY_SIZE   = 16384;  // 14-bit index: from(7) + to(7)
constexpr int CORRHIST_BASE_SIZE       = BUTTERFLY_HISTORY_SIZE;
...
using ButterflyHistory = Stats<std::int16_t, 7183, COLOR_NB, BUTTERFLY_HISTORY_SIZE>;

// LowPlyHistory is addressed by ply and move's from and to squares, used
// to improve move ordering near the root
using LowPlyHistory = Stats<std::int16_t, 7183, LOW_PLY_HISTORY_SIZE, BUTTERFLY_HISTORY_SIZE>;
