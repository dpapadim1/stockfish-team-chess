...
struct Cluster {
    ...
    // No padding needed — 3×12 = 36, next cache-line multiple is 64
    // Relax alignment to allow any cluster size
};

// Note: with 32-bit Move, Cluster is now 36 bytes (was 32)
// static_assert(sizeof(Cluster) == 36, "Cluster size check");
